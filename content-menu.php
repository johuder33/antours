...
<header class="container">
    <nav class="row align-items-center menu">
        ...
        <div class="col-xs-12 col-sm-12 col-md col-lg col-xl order-12 order-md-1 menu-list">
        ...
        <div class="col-xs-12 col-sm-12 col-md-auto col-lg-auto col-xl-auto order-1 order-md-12">
